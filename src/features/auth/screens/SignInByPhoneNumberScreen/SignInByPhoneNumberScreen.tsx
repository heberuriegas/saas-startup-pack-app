...
export type SignInByPhoneNumberScreenProps = StackScreenProps<AuthPhoneNumberStackParams, 'SignIn'>;

export const SignInByPhoneNumberScreen: React.FC<SignInByPhoneNumberScreenProps> = ({
  navigation: { navigate },
  route: {
    params: { phoneNumber },
  },
